...
Interface.prototype.sendMessage = function (endpointArn, msg, sound, callback) {
  var self = this
    , convertFn = null;
  ...
  convertFn.call(this, msg, sound,function (err, message) {
    try {
      self.sns.publish({
        Message: JSON.stringify(message),
...
Interface.prototype.convertToGcmFormat = function (message, sound, callback) {
...
Interface.prototype.convertToApnsFormat = function (message, sound, callback) {
